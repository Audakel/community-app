(function (module) {
    mifosX.controllers = _.extend(module, {
        MainController: function (scope, location, sessionManager, translate, $rootScope, localStorageService, keyboardManager, $idle, tmhDynamicLocale, 
            ...
            scope.text = '<span>We imagine a world where all people, no matter how remote, are connected through mobile technology; enabling them to create opportunity for themselves, as well as their families and community.  We believe providing secure, simple, and affordable access to capital will achieve this.</span>';
